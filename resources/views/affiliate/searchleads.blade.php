...
<div class="panel panel-default">
    <div class="panel-body">
        {!! Form::open(['url' => url('affiliate/searchLeads'),'class'=> '','id'=>'search-leads',]) !!}

            {!! Form::hidden('affiliate_id', auth()->user()->affiliate->id, ['class' => 'this_field form-control', 'id' => 'affiliate_id']) !!}
            ...
            <div class="row container-fluid">
                ...
                <!-- <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 col-lg-offset-4 col-md-offset-3 col-sm-offset-4 col-xs-offset-4"> -->
                    ...
                    @if(session()->has('searched_searched_leads'))
                        {!! Html::link(url('affiliate/downloadSearchedLeads'),'Download Leads',['class' =>'btn btn-primary', 'id' => 'downloadSearchedLeads']) !!}
                    @endif
                </div>
            </div>
            <hr>
                    ...
                    <div class="container-fluid">
                        <div class="row">
                            <div class="form-group col-md-12 col-lg-12">
                                ...
                                {!! Form::textarea('sent_result',null, ['class' => 'this_field form-control', 'id' => 'sent_result', 'required' => 'true', 'rows' => 4, 'disabled' => true]) !!}
                            </div>
                        </div>
                    </div>
                    @include('partials.error')
...
<script>
    ...
    $(document).ready(function()
    {
        ...
        $('.show-details').click(function()
        {
            ...
            var getDetailsURL = $('#baseUrl').val()+'/affiliate/leads/'+leadID+'/getLeadDetails';
