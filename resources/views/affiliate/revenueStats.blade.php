...
<div class="panel panel-default">
    <div class="panel-body">
        {!! Form::open(['url' => url('affiliate/revenueStatistics'),'class'=> '', 'id' => 'search-leads']) !!}
            ...
            <div class="row container-fluid">
                ...
                <!-- <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 col-lg-offset-4 col-md-offset-3 col-sm-offset-4 col-xs-offset-4"> -->
                    ...
                    @if(session()->has('searched_revenue_leads'))
                        {!! Html::link(url('affiliate/downloadRevenueReport'),'Download Report',['class' =>'btn btn-primary', 'id' => 'downloadRevenueReport']) !!}
                    @endif
                </div>
            </div>
            <hr>
