...
<div class="row">
    ...
    <div class="col-xs-12 container-fluid">
        <table data-affiliate="{{ auth()->user()->affiliate->id }}" id="contacts-table" class="table table-bordered table-striped table-hover table-heading table-datatable responsive-data-table">
            <thead>
                <tr>
                    <th>Name</th>
                    <th>Position</th>
