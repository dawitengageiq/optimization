                    ...
                    <div class="container-fluid">
                        <div class="row">
                            <div class="form-group col-md-6 col-lg-6">
                                ...
                                {!! Form::select('affiliate_id',Bus::dispatch(new GetAffiliatesCompanyIDPair()),null,['class' => 'form-control','id' => 'affiliate_id']) !!}
                             </div>
                             <div class="form-group col-md-6 col-lg-6">
                                {!! Form::checkbox('advertiser_checkbox',true,true,['class' => '', 'id' => 'advertiser_checkbox']) !!}
                                {!! Form::label('advertiser','Advertiser') !!}
                                {!! Form::select('advertiser_id',Bus::dispatch(new GetAdvertisersCompanyIDPair()),null,['class' => 'form-control','id' => 'advertiser_id']) !!}
                            </div>
...
<div class="row">
    ...
    <div class="col-xs-12 container-fluid">
        <table data-advertiser="{{ auth()->user()->advertiser->id }}" id="contacts-table" class="table table-bordered table-striped table-hover table-heading table-datatable responsive-data-table">
            <thead>
                <tr>
                    <th>Name</th>
                    <th>Position</th>
