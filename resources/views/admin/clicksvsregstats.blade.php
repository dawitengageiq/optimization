...
@section('content')
        ...
        <div class="panel-body">
            ...
            <div class="row">
                ...
                <div class="form-group col-md-3 col-lg-3 col-sm-12">
                    ...
                    {!! Form::select('group_by', ['created_at' => 'Day Per SubID', 'custom' => 'Day Per Revenue Tracker', 'revenue_tracker_id' => 'Revenue Tracker', 'per_sub_id' => 'Per SubID'], isset($inputs['group_by']) ? $inputs['group_by'] : '',['class' => 'this_field form-control','id' => 'group_by']) !!}
                </div>
            ...
            <div class="row container-fluid">
                <div class="text-center">
                    ...
                    {!! Html::link(url('admin/downLoadClicksVsRegistrationReport'),'Download Report',['class' =>'disabled btn btn-primary', 'id' => 'download-clicks-vs-registration-report']) !!}
                </div>
            </div>
            <hr>
            {!! Form::close() !!}
    ...
    <div class="row">
        <div class="container-fluid">
            <table id="clicks-vs-registration-table" class="publisher_reports_table_design table table-bordered table-striped table-hover table-heading table-datatable responsive-data-table">
                <thead>
                    <tr>
                        <th>Date</th>
...
@section('footer')
    ...
    <script src="{{ asset('js/admin/clicks-vs-registration.min.js') }}"></script>
@stop