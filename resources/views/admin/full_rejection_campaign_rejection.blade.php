...
@section('title')
	Campaign Full Rejection Charts
@stop
...
<div class="panel panel-default">
    <div class="panel-body">
        {!! Form::open(['url' => url('admin/campaign/100percent_rejection'),'class'=> '', 'id' => 'campRejection-form', 'method' => 'GET']) !!}
...
@section('footer')
	...
	<script>
		...
		// console.log(group_categories['high'])

		if(group_categories['critical'] != undefined) {
		...
		if(group_categories['high'] != undefined) {
