		...
		$.ajax({
			...
			success : function(campaigns) {
				...
				$.each(campaigns, function(i, campaign) {
					$('#campaign-priority-sort').append('<tr id="cmpprt-'+campaign.id+'"><td>'+campaign.priority+'</td><td>'+campaign.name+'</td></tr>');
		...
		$.ajax({
			...
			success : function(campaign_priority) {
				...
				$.each(campaign_priority, function(i, new_sort) {
					$('#campaign-priority-sort').append('<tr id="cmpprt-'+new_sort.id+'"><td>'+new_sort.priority+'</td><td>'+new_sort.name+'</td></tr>');
