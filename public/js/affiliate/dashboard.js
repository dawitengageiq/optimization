...
$(document).ready(function()
{
    ...
    var the_url = baseURL+'/affiliate/activeCampaigns';
    $.ajax({
        type: 'POST',
        url: the_url,
        success: function(data){
    ...
    the_url = baseURL+'/affiliate/topTenCampaignsByRevenueYesterday';
    ...
    the_url = baseURL+'/affiliate/topTenCampaignsByRevenueForCurrentWeek';
    $.ajax({
        type: 'POST',
        url: the_url,
        success: function(data){
    ...
    the_url = baseURL+'/affiliate/topTenCampaignsByRevenueForCurrentMonth';
    $.ajax({
        type: 'POST',
        url: the_url,
        success: function(data){
    ...
    the_url = baseURL+'/affiliate/leadCounts';
    $.ajax({
        type: 'POST',
        url: the_url,
        success: function(data){
