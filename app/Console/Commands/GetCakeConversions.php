...
class GetCakeConversions extends Command
{
     ...
     * @var string
     */
    protected $signature = 'get:cake-conversions';
     ...
     * @var string
     */
    protected $description = 'This command will get all cake conversions from Cake through their API.';
    ...
    public function handle(): void
    {
        ...
        // $startDate = '2017/02/09 23:00:00';
        // $endDate = '2017/02/09 23:59:59';

        /*
        $startDate = Carbon::now()->subHour()->format('Y/m/d H:00:00');
        $endDate = Carbon::now()->format('Y/m/d H:00:00');

        $this->info('Range: '.$startDate.' - '.$endDate);
        ...
        else
        {
            ...
            do
            {
                ...
                $this->info('Fetching conversions using the following URL: ');
                $this->info($conversionURL);
        ...
        */
        ...
        $job = (new \App\Jobs\GetCakeConversions())->delay(3);
        dispatch($job);

        $this->info('All conversions will be fetched shortly!');
    }
}
